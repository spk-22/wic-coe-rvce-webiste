...
import { Home, Cloud, Building, Users, BookOpen, Phone, HelpCircle, Calendar, Briefcase } from "lucide-react"
...
export default function SideNav() {
  ...
  return (
    <nav className="hidden md:block fixed left-0 top-[140px] bottom-0 w-[220px] bg-card/80 backdrop-blur-sm border-r border-border/40 shadow-sm">
      <div className="py-4">
